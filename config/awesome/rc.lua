...
local alternative_browser = "chromium"
local file_explorer = "spacefm"
...
globalkeys = my_table.join(
    ...
    awful.key({ modkey }, "F2", function () awful.spawn(alternative_browser) end,
              {description = "run alternative browser", group = "launcher"}),
    awful.key({ modkey }, "F3", function () awful.spawn(file_explorer) end,
